...
$GDok = TRUE;
// ------------ config section --------------------
$IMGFOLDER = '/var/www/pogrem11292/data/www/aleks-rent.com.ua/photos';
$IMGURL = 'http://aleks-rent.com.ua/photos';
$VIDEOICON = 'video.jpg';
$AUDIOICON = 'audio.jpg';
// language setting   en
$LARGEIMG = 'Истиный размер';
$DELETEIMG = 'Удалить';
$INSERTIMG = 'выбрать';
$UPLOADIMG = 'Загрузить';
$HELPSTR = 'Кликните по нужному изображению!';
// -------------------------------------------------
?>
  ...
  if (count($file_lista) > 0) {
  	for ( $a=0; $a<sizeof($file_lista); $a++) {
          ...
          if (((substr($fnev,-4)==".jpg") || (substr($fnev,-4)==".gif") ||
                ...
                // ha mйg nincsbйlyegkйp akkor lйtrehozni
